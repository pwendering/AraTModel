function k_c_adj = adj_k_c(varargin)
%% k_c_adj = adj_k_c(varargin)
% Adjust the turnover number of RuBisCO carboxylase activity to temperature.
...
%   scalar k25:         k_c value at 25 °C [s^-1]
%                       default: 3.53 s^-1
% Output:
%   double k_c_adj:     adjusted k_c value

T_DEFAULT = 298.15;     % [K]
K25_DEFAULT = 3.53; 	% [s^-1]
R = 8.3145;             % [J mol^-1 K^-1]
Ea_10_25 = 90360;       % [J mol^-1]
Ea_25_40 = 62200;       % [J mol^-1]
...
k_c_adj = k25*exp(-Ea*(298.15-T)./(R*T*298.15));
